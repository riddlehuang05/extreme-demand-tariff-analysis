...
| --- | --- | --- |
| `method_fidelity_summary.csv` | Five-method quantile, mean, and stop-loss fidelity | Table 2 |
...
[Additional analysis tables](../docs/FUNCTIONAL_ANALYSES.md) include the paired
functional correlations, Gaussian comparisons, stability radii, and contract
objective comparisons reported in Tables S11-S14.
